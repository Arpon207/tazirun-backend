import DataModel from "../../../models/Areas/division/DivisionModel.js";
...
// Details
export const DivisionDetails = async (req, res) => {
    const result = await DetailsByIdService(req, DataModel);
    res.json(result);
}

// DropDown
export const DivisionDropDown = async (req, res) => {
    const result = await DropdownService(req, DataModel, {_id: 1, name: 1});
    res.json(result);
}

// Delete
export const DivisionDelete = async (req, res) => {
