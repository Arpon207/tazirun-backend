...
import * as ProductVariantController from "../app/controllers/productVariant/ProductVariantController.js";

import upload from "../../server/app/middlewares/UplaodFileMiddleware.js";
import multiUpload from "../../server/app/middlewares/UploadMultipleFileMiddleware.js";
...
router.get('/GetZoneInsideCities/:city_id/zones', AuthMiddleware, PathaoController.GetZoneInsideCities);
router.get('/GetAreaInsideZone/:zone_id/areas', AuthMiddleware, PathaoController.GetAreaInsideZone);
...
router.post('/ProfileUpdate', AuthMiddleware , upload.single('photo'), UsersController.ProfileUpdate);
router.post('/Logout', AuthMiddleware , UsersController.Logout);
router.get('/UserDetails/:role/:pageNo/:perPage/:searchKeyword', AuthMiddleware , UsersController.UserDetails);
router.get('/DetailsByIdService/:id', AuthMiddleware, UsersController.DetailsByIdService);
router.post('/UpdateByIdService/:id', AuthMiddleware, UsersController.UpdateByIdService);
router.get('/DeleteUser/:id', AuthMiddleware, UsersController.DeleteUser);

// Brands Route
router.post('/CreateBrand', AuthMiddleware, upload.single('image'), BrandsController.CreateBrand);
router.post('/UpdateBrand/:id', AuthMiddleware, upload.single('image'), BrandsController.UpdateBrand);
...
// Banner Route
router.post('/CreateBanner', AuthMiddleware, upload.single('image'), BannerController.CreateBanner);
router.post('/UpdateBanner/:id', AuthMiddleware, upload.single('image'), BannerController.UpdateBanner);
router.get('/BannerList/:pageNo/:perPage/:searchKeyword', AuthMiddleware , BannerController.BannerList);
router.get('/DeleteBanner/:id', AuthMiddleware , BannerController.DeleteBanner);
router.get('/BannerDetails/:id', AuthMiddleware , BannerController.BannerDetails);
router.get('/AllBanner', BannerController.AllBanner);

// Categories Route
router.post('/CreateCategory', AuthMiddleware, upload.single('image'), CategoriesController.CreateCategory);
router.post('/UpdateCategory/:id', AuthMiddleware, upload.single('image'), CategoriesController.UpdateCategory);
...
router.get('/AllCatWithSubCatAndSubSubCat', CategoriesController.AllCatWithSubCatAndSubSubCat);

// Sub Categories Route
router.post('/CreateSubCategory', AuthMiddleware, upload.single('image'), SubCategoriesController.CreateSubCategory);
router.post('/UpdateSubCategory/:id', AuthMiddleware, upload.single('image'), SubCategoriesController.UpdateSubCategory);
router.get('/SubCategoryList/:pageNo/:perPage/:searchKeyword', AuthMiddleware , SubCategoriesController.SubCategoryList);
router.get('/DeleteSubCategory/:id', AuthMiddleware , SubCategoriesController.DeleteSubCategory);
router.get('/SubCategoryDropDown/:id', AuthMiddleware , SubCategoriesController.SubCategoryDropDown);
router.get('/OnlySubCategoryDropDown', AuthMiddleware , SubCategoriesController.OnlySubCategoryDropDown);
router.get('/SubCategoryDetails/:id', AuthMiddleware , SubCategoriesController.SubCategoryDetails);

// Sub Sub Categories Route
router.post('/CreateSubSubCategory', AuthMiddleware, upload.single('image'), SubSubCategoriesController.CreateSubSubCategory);
router.post('/UpdateSubSubCategory/:id', AuthMiddleware, upload.single('image'), SubSubCategoriesController.UpdateSubSubCategory);
router.get('/SubSubCategoryList/:pageNo/:perPage/:searchKeyword', AuthMiddleware , SubSubCategoriesController.SubSubCategoryList);
router.get('/SubSubCategoryDropDown/:id', AuthMiddleware , SubSubCategoriesController.SubSubCategoryDropDown);
router.get('/DeleteSubSubCategory/:id', AuthMiddleware , SubSubCategoriesController.DeleteSubSubCategory);
router.get('/SubSubCategoryDetails/:id', AuthMiddleware , SubSubCategoriesController.SubSubCategoryDetails);

// District Route
router.post('/CreateDistrict', AuthMiddleware , DistrictsController.CreateDistrict);
router.post('/UpdateDistrict/:id', AuthMiddleware , DistrictsController.UpdateDistrict);
router.get('/DistrictList/:pageNo/:perPage/:searchKeyword', AuthMiddleware , DistrictsController.DistrictList);
router.get('/DistrictDetails/:id', AuthMiddleware , DistrictsController.DistrictDetails);
router.get('/DistrictDropDown', AuthMiddleware , DistrictsController.DistrictDropDown);
router.get('/DistrictDelete/:id', AuthMiddleware , DistrictsController.DistrictDelete);

// Division Route
router.post('/CreateDivision', AuthMiddleware , DivisionsController.CreateDivision);
router.post('/UpdateDivision/:id', AuthMiddleware , DivisionsController.UpdateDivision);
router.get('/DivisionList/:pageNo/:perPage/:searchKeyword', AuthMiddleware , DivisionsController.DivisionList);
router.get('/DivisionDetails/:id', AuthMiddleware , DivisionsController.DivisionDetails);
router.get('/DivisionDropDown', AuthMiddleware , DivisionsController.DivisionDropDown);
router.get('/DivisionDelete/:id', AuthMiddleware , DivisionsController.DivisionDelete);
...
router.get('/ThanaList/:pageNo/:perPage/:searchKeyword', AuthMiddleware , ThanaController.ThanaList);
...
router.get('/RegionList/:pageNo/:perPage/:searchKeyword', AuthMiddleware , RegionController.RegionList);
router.get('/RegionDetails/:id', AuthMiddleware , RegionController.RegionDetails);
...
router.get('/CustomerRegionDropDown', AuthMiddleware , CustomersController.CustomerRegionDropDown);
router.get('/CustomerThanaDropDown', AuthMiddleware , CustomersController.CustomerThanaDropDown);
router.get('/CustomerDistrictDropDown', AuthMiddleware , CustomersController.CustomerDistrictDropDown);
router.get('/CustomerDivisionDropDown', AuthMiddleware , CustomersController.CustomerDivisionDropDown);
...
router.post('/CreateProductVariant', AuthMiddleware, upload.single('image'), ProductVariantController.CreateProductVariant);
router.post('/UpdateProductVariant/:id', AuthMiddleware, upload.single('image'), ProductVariantController.UpdateProductVariant);
router.get('/AllVariantDetails/:id', ProductVariantController.AllVariantDetails);
router.get('/ProductVariantList/:pageNo/:perPage/:searchKeyword', AuthMiddleware , ProductVariantController.ProductVariantList);
router.get('/DeleteVariant/:id', AuthMiddleware , ProductVariantController.DeleteVariant);

// Products Route
router.post('/CreateProduct', AuthMiddleware, upload.fields([
    { name: 'image', maxCount: 1 },
    { name: 'hoverImage', maxCount: 1 }
]), ProductsController.CreateProduct);

router.post('/UpdateProduct/:id', AuthMiddleware, upload.fields([
    { name: 'image', maxCount: 1 },
    { name: 'hoverImage', maxCount: 1 }
...
router.get('/ProductDetailByRemark/:remark', ProductsController.ProductDetailByRemark);
router.get('/ProductDetailByCategoryName/:catName', ProductsController.ProductDetailByCategoryName);
router.get('/AllProductDetailByCategoryName/:catName/:pageNo/:perPage/:searchKeyword', ProductsController.AllProductDetailByCategoryName);
router.get('/AllProductDetailByRemark/:remark/:pageNo/:perPage/:searchKeyword', ProductsController.AllProductDetailByRemark);
router.get('/AllProductDetailByCategory/:id/:pageNo/:perPage/:searchKeyword', ProductsController.AllProductDetailByCategory);
router.get('/AllProductDetailByBrand/:id/:pageNo/:perPage/:searchKeyword', ProductsController.AllProductDetailByBrand);
router.get('/AllProductDetailBySlider/:id/:pageNo/:perPage/:searchKeyword', ProductsController.AllProductDetailBySlider);
router.get('/AllProductDetailBySearch/:keyword/:pageNo/:perPage', ProductsController.AllProductDetailBySearch);
router.get('/AllProductDetailByCampaign/:id/:pageNo/:perPage/:searchKeyword', ProductsController.AllProductDetailByCampaign);

// Marketing Campaign Route
router.post('/CreateCampaign', AuthMiddleware, upload.single('image'), MarketingCampaignController.CreateCampaign);
router.post('/UpdateCampaign/:id', AuthMiddleware, upload.single('image'), MarketingCampaignController.UpdateCampaign);
router.get('/CampaignList/:pageNo/:perPage/:searchKeyword', AuthMiddleware , MarketingCampaignController.CampaignList);
router.get('/AllCampaign', MarketingCampaignController.AllCampaign);
router.get('/CampaignById/:id', AuthMiddleware, MarketingCampaignController.CampaignById);
router.get('/DeleteCampaign/:id', AuthMiddleware, MarketingCampaignController.DeleteCampaign);
router.get('/CampaignDropDown', AuthMiddleware , MarketingCampaignController.CampaignDropDown);
...
// Summary Route
router.get('/TotalRevenueSummary', AuthMiddleware , SummaryController.TotalRevenueSummary);
...
router.get('/SaleSummaryByDistrict/:district', AuthMiddleware , SummaryController.SaleSummaryByDistrict);

// Sliders Route
router.post('/CreateSlider', AuthMiddleware, upload.single('image'), SliderController.CreateSlider);
router.post('/UpdateSlider/:id', AuthMiddleware, upload.single('image'), SliderController.UpdateSlider);
router.get('/SliderList/:pageNo/:perPage/:searchKeyword', AuthMiddleware , SliderController.SliderList);
router.get('/DeleteSlider/:id', AuthMiddleware , SliderController.DeleteSlider);
router.get('/SliderDetails/:id', AuthMiddleware , SliderController.SliderDetails);
...
router.post('/UpdateCartList/:id', CartController.UpdateCartList);
router.get('/DeleteCartList/:id', CartController.DeleteCartList);

// Wishes Route
router.get('/WishList', WishController.WishList);
router.post('/SaveWishList', WishController.SaveWishList);
router.get('/RemoveWishList/:id', WishController.RemoveWishList);

// Invoice Route
router.post('/CreateInvoice',InvoiceController.CreateInvoice);
router.get('/InvoiceList/:status', AuthMiddleware, InvoiceController.InvoiceList);
router.post('/UpdateInvoiceList/:id', AuthMiddleware, InvoiceController.UpdateInvoiceList);
router.post('/InvoiceListByDeliveryStatus/:status', AuthMiddleware, InvoiceController.InvoiceListByDeliveryStatus);
router.post('/InvoiceListCount', AuthMiddleware, InvoiceController.InvoiceListCount);
router.get('/DeleteInvoice/:id', AuthMiddleware , InvoiceController.DeleteInvoice);

// Review Route
router.post('/CreateReview/:id', upload.array('images', 5), ReviewController.CreateReview);
router.get('/ReviewList/:id', ReviewController.ReviewList);
router.get('/ReviewDelete/:id', ReviewController.ReviewDelete);
